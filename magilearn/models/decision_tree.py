...
class DecisionTreeRegressor:
    ...
    该决策树实现基于递归划分数据并使用均方误差 (MSE) 来选择最佳特征和划分阈值。
    ...
    def _best_split(self, X, y):
        ...
        for feature in features_to_consider:
            ...
            for threshold in thresholds:
                ...
                mse = (len(y_left) / n_samples * self._mse(y_left)
    ...
    def score(self, X, y):
        ...
        参数：
            X (numpy.ndarray): 测试数据的特征。
            y (numpy.ndarray): 测试数据的真实值。
